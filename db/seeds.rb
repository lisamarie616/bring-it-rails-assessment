...
User.create(email: "scotty@buttons.com", password: "bones123", first_name: "Scotty", last_name: "Buttons")
User.create(email: "teddy@bear.com", password: "playtime", first_name: "Teddy", last_name: "Bear")
